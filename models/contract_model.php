...
class contract_model extends CI_Model{
	...
	*/
	...
	public function getBot(){
		$sql = " select * from df_recommend where judge=1 and is_show=1 order by `real` asc limit 10";
		$result = $this->db->query($sql);
		$arr = $result->result_array();
		return $arr;
	}
	...
	public function result(){
		$sql = 'select * from df_recommend where is_show=1 and judge=2 order by `real` asc limit 10';
		$result = $this->db->query($sql);
		$arr = $result->result_array();
		return $arr;
	}
