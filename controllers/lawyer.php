...
class lawyer extends base{
  ...
  public function index(){
	...
	$data['lawyer'] = $this->recomand_lawyer(10,3);//推荐律师
	$data['lawfirm'] = $this->laywer->getFirm();//推荐律师
  $data['registerfrim'] = $this->laywer->getRegFirm();
  	$this->load->view('default/lawyer.php',$data);
  }
  /*
   * 律师详情页
   */
